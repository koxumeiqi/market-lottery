...
import com.ly.domain.rebate.model.entity.TaskEntity;
import com.ly.domain.rebate.model.vo.BehaviorTypeVO;
import com.ly.domain.rebate.model.vo.DailyBehaviorRebateVO;
import com.ly.domain.rebate.repository.IBehaviorRebateRepository;
import com.ly.infrastructure.event.EventPublisher;
import com.ly.infrastructure.persistent.dao.IDailyBehaviorRebateDao;
import com.ly.infrastructure.persistent.dao.IUserBehaviorRebateOrderDao;
    ...
    public void saveUserRebateRecord(String userId, List<BehaviorRebateAggregate> behaviorRebateAggregates) {
        ...
        for (BehaviorRebateAggregate behaviorRebateAggregate : behaviorRebateAggregates) {
            ...
            try {
                ...
                eventPublisher.publish(taskEntity.getTopic(), JSON.toJSONString(taskEntity.getMessage()));
                // 更新数据库记录，task 任务表
